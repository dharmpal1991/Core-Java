...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.webserviceDemo.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:9090/CalculatorService/services/CalService";
    ...
    public com.webserviceDemo.CalService getCalService() throws javax.xml.rpc.ServiceException {
    ...
    public com.webserviceDemo.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webserviceDemo.CalServiceSoapBindingStub _stub = new com.webserviceDemo.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webserviceDemo.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webserviceDemo.CalServiceSoapBindingStub _stub = new com.webserviceDemo.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webserviceDemo.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webserviceDemo.com", "CalService"));
        }
